      ...
      <div className="p-1.5">
        ...
        <div className="mx-1">
          <NavLink
            ...
            to="/dashboard"
            style={({ isActive }) => setHome(isActive)}
            className={`${
              home && " bg-white bg-opacity-10"
            } flex w-full p-2.5 px-3 items-center  rounded transition duration-400 ease-in-out text-white hover:text-opacity-100 text-opacity-70 group  text-white `}
          >
            <svg
              width="20"
              height="20"
              ...
              className={`${
                home
                  ? "fill-current text-white stroke-current"
                  : "stroke-current text-white"
              } mr-4`}
            >
              <path d="M37.0797 39H23.7955V25.5H16.2045V39H2.92029V10.9406L20 1L37.0797 10.8728V39Z" />
            </svg>
            <h1 className={`${home && "text-white"} text-sm`}> Home</h1>
          </NavLink>
          <NavLink
            style={({ isActive }) => setSearch(isActive)}
            end
            to="/dashboard/search"
            className={`${
          ...
          >
            ...
            <h1 className={`${search && "text-white"} text-sm`}> Search</h1>
          </NavLink>
          <NavLink
            style={({ isActive }) => setLib(isActive)}
            end
            to="/dashboard/library"
            className={` ${
              lib && " bg-white bg-opacity-10"
            } flex w-full p-2.5 px-3 items-center  rounded transition duration-400 ease-in-out text-white hover:text-opacity-100 text-opacity-70 group  text-white `}
          >
            <svg
              width="20"
            ...
            >
              <path d="M22.9419 1.64966L39 37.7129L37.1368 38.5465L21.0788 2.48322L22.9419 1.64966ZM1 38.522V1.45351H3.05942V38.522H1ZM13.3562 38.522V1.45351H15.4156V38.522H13.3562Z" />
            </svg>
            <h1 className={`${lib && "text-white"} text-sm`}> Your Library</h1>
          </NavLink>

          <div className="mt-6">
            <NavLink
              style={({ isActive }) => setPlaylist(isActive)}
              end
              to="/dashboard/create_playlist"
              className={`${
                playlist && " bg-white bg-opacity-10"
              } flex w-full p-2.5 px-3 items-center  rounded transition duration-400 ease-in-out text-white hover:text-opacity-100 text-opacity-70 group  text-white `}
            >
              <div className="bg-white group-hover:bg-white bg-opacity-60 group-hover:bg-white  bg-opacity-60 p-1.5 transition duration-400 ease-in-out">
                <FaPlus size={12} color="black" />
              </div>

              <h1 className={`${playlist && "text-white"} text-sm ml-3 `}>
                {" "}
                Create Playlist
              </h1>
            </NavLink>
            <NavLink
              style={({ isActive }) => setFav(isActive)}
              end
              to="/dashboard/fav"
              className={` ${
                fav && " bg-white bg-opacity-10"
              } flex w-full p-2.5 px-3 items-center  rounded transition duration-400 ease-in-out text-white hover:text-opacity-100 text-opacity-70 group  text-white `}
            >
              <div className="bg-gradient-to-br from-purple-900 via-purple-500 to-purple-200  group-hover:bg-white  bg-opacity-60 p-1.5 transition duration-400 ease-in-out">
                <BsFillHeartFill size={12} />
              </div>

              <h1 className={`${fav && "text-white"} text-sm ml-3 `}>
                {" "}
                Liked Songs
              </h1>
            </NavLink>
